...
Begin VB.Form formDeleteUser 
   ...
   Begin VB.ComboBox regAccountType 
      Height          =   315
      ItemData        =   "formDeleteUser.frx":0000
      Left            =   9780
      List            =   "formDeleteUser.frx":000A
      Locked          =   -1  'True
      Sorted          =   -1  'True
      TabIndex        =   6
      Top             =   3900
   ...
   Begin VB.Label Label19 
      BackStyle       =   0  'Transparent
      Caption         =   "Please select (double click) a user below  to be deleted :"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   9
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "formDeleteUser"
...
Private Sub cmdDelete_Click()
    ...
    choice = MsgBox("Are you sure you want to delete user", vbYesNo, "Confirm Delete")
    If choice = vbNo Then
        Exit Sub
    End If
